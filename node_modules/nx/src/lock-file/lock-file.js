...
function mapLockFileDataToPartialGraph(lockFileData, packageManager = (0, package_manager_1.detectPackageManager)(workspace_root_1.workspaceRoot)) {
    let externalNodes;
    if (packageManager === 'yarn') {
        externalNodes = (0, utils_1.mapExternalNodes)(lockFileData, yarn_1.transitiveDependencyYarnLookup);
    }
    if (packageManager === 'pnpm') {
        externalNodes = (0, utils_1.mapExternalNodes)(lockFileData, pnpm_1.transitiveDependencyPnpmLookup);
    }
    if (packageManager === 'npm') {
        externalNodes = (0, utils_1.mapExternalNodes)(lockFileData, npm_1.transitiveDependencyNpmLookup);
    }
    if (externalNodes) {
        (0, utils_1.hashExternalNodes)(externalNodes);
 ...
 */
function pruneLockFile(lockFile, packages, projectName, packageManager = (0, package_manager_1.detectPackageManager)(workspace_root_1.workspaceRoot)) {
    if (packageManager === 'yarn') {
