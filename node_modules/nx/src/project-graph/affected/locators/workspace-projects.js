...
const getTouchedProjects = (touchedFiles, projectGraphNodes) => {
    const projectRootMap = (0, target_project_locator_1.createProjectRootMappings)(projectGraphNodes);
    return touchedFiles.reduce((affected, f) => {
        const matchingProject = (0, target_project_locator_1.findMatchingProjectForPath)(f.file, projectRootMap);
        if (matchingProject) {
