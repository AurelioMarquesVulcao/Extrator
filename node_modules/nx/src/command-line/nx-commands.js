...
exports.commandsObject = yargs
    ...
    builder: (yargs) => linkToNxDevAndExamples(withRunManyOptions(withOutputStyleOption(withTargetOption(yargs))), 'run-many'),
    ...
    builder: (yargs) => linkToNxDevAndExamples(withAffectedOptions(withRunOptions(withOutputStyleOption(withTargetOption(yargs)))), 'affected'),
    ...
    describe: false,
    builder: (yargs) => linkToNxDevAndExamples(withAffectedOptions(withRunOptions(withOutputStyleOption(yargs))), 'affected'),
    handler: (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
function withRunManyOptions(yargs) {
    return withRunOptions(yargs)
        ...
        .option('projects', {
        describe: 'Projects to run. (comma delimited project names and/or patterns)',
        type: 'string',
    })
        .option('all', {
...
function withRunOneOptions(yargs) {
    ...
    const res = withRunOptions(withOutputStyleOption(withTargetOption(yargs, false), [
        'dynamic',
        'static',
        'stream',
