...
const server = (0, net_1.createServer)((socket) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    socket.on('close', () => {
        ...
        registeredFileWatcherSockets = registeredFileWatcherSockets.filter((watcher) => watcher.socket !== socket);
    });
}));
...
const handleWorkspaceChanges = (err, changeEvents) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield notifyFileWatcherSockets(changedFiles);
...
function notifyFileWatcherSockets(changedFiles) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield Promise.all(registeredFileWatcherSockets.map(({ socket, filter }) => handleResult(socket, {
